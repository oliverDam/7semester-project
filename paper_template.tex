...
\author{Simon,Oliver,Martin,Irene}% <-this % stops a space
...
%Hypothesis
%This study aims at a novel approach to verify if it is possible, applying simple linear regression techniques to achive simultaneous and proportional control of two DOFs in lower-arm prosthesis and mitigate the effect of the different limb positions have on the control of this devices using EMG signals as well as IMU data.	
