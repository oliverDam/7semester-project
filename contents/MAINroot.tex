...
\begin{multicols}{2}
	...
	%text addressing the superpoisons
...
%				LogVar, Ulnar Dev. & 0.1312 & $\pm 0.0310$ \\
	...
	\end{center}
	A Kolmogorov-Smirnov test was applied to all individual data sets, and indicated no data set to be normal distribued. Thus, a Friedman's test was applied for all statistical analysis.
	
	Analysing the RMSE of the regression models' response to the training data, it was found that there's a significant difference (p = 0.0044) between MAV and LogVar, where it was shown that LogVar (mean = 0.1178, std = 0.0272) has a higher mean than MAV (mean = 0.1059, std = 0.0306), as seen in table \ref{tab:RMSEtrain-test}. 
