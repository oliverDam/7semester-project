...
\begin{figure}[H]
	...
	{                                                                  %\
		\includegraphics[width=.46\textwidth]{figures/posteriorSuperior}         %\
	}                                                                    %\
	\hspace{5pt}                                                          %\
	\subcaptionbox  %<-----------------------------------------------------%\
	{                                                                       %\
	...
	{                                                                            %\
		\includegraphics[width=.46\textwidth]{figures/posteriorMiddle}            %|
	}                                                                             %|
...
\begin{figure}[H]
	\includegraphics[width=.4\textwidth]{figures/wrist}  %<--but is not needed.
...
\begin{figure}[H]                    
	\includegraphics[width=.4\textwidth]{figures/wristFingers}  %<--but is not needed.
