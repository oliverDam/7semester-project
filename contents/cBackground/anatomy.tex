...
The human arm is designed to give humans a manoeuvrability and dexterity to coordinate and execute complicated and precise hand and finger movements with ease. Each movement happen on an axis, and each axis denotes one degree of freedom (DOF). The arm posses six DOFs as shown in \figref{fig:armDOF}.
