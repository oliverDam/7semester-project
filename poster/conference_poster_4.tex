...
\begin{center}
	...
	\captionof*{figure}{\textbf{Figure 3:} Superimposition of test data and the regressor output for the MAV feature.}
\end{center} %\vspace{-3.5cm}

\begin{center}
	\includegraphics[width=1\linewidth]{NewSuperPoisonLogVarNewData}
	\captionof*{figure}{\textbf{Figure 4:} Superimposition of test data and the regressor output for the LogVar feature.}
\end{center} %\vspace{7cm}
	
	
\begin{center}
	\includegraphics[width=1\linewidth]{RMSEBarPlotNewData}
	\captionof*{figure}{\textbf{Figure 5:} RMSE when using test data}
\end{center}
...
\begin{center}
	...
	\captionof*{figure}{\textbf{Figure 6:} The mean test score among seven subjects when using regressors trained with MAV}
\end{center}

\vspace{-0.6cm}
\begin{center}
	\includegraphics[width=0.7\linewidth]{gotItLogVar}
	\captionof*{figure}{\textbf{Figure 7:} The mean test score among seven subjects when using regressors trained with LogVar}
\end{center}
