...
\section{RESULTS}%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{figure*}[thpb]
		\centering
		\includegraphics[width=0.6\textwidth]{figures/NewSuperPositionTestDataMAV}  %<--but is not needed.
	...
	\begin{figure*}[thpb]
		\centering
		\includegraphics[width=0.6\textwidth]{figures/NewSuperPositionTestDataLogVar}  %<--but is not needed.
	...
	\begin{figure}[thpb]
		...
		\caption{Plot of the actual data, red plot, superimposed on the output of the regressors trained with the MAV features. The plot is divided into four segments, where each segment shows a different movement performed. Each segment has the same ample size.}
