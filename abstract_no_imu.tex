...
\textbf{Background:} Electromyography (EMG) is widely used as input to the control scheme of functional prosthetics. However, EMG signals change with limb position and thus lowers the accuracy in pattern recognition \cite{Fougner2010}.% and very few studies has assessed this problem.
